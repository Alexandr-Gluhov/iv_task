...
class UserLogic
{
    public static function signUp(
        ...
        if (!preg_match("/^[\w!?-_]{7,}$/", $password1) || !preg_match('/[a-z]/', $password1) || !preg_match('/[A-Z]/', $password1) || !preg_match('/[!?_-]/', $password1) || !preg_match('/\d/', $password1)) {
            $errors[] = "Пароль не удовлетворяет требованиям безопасности. Пароль должен содержать: маленькие и большие буквы латинского алфавита, цифры и особые символы (любой из !?_-) и ни из каких других, а также быть не менее 7 символов";
        }
