...
class UserLogic
{
    public static function signUp(
        ...
        if (!preg_match("/[\w@#&+()\/*\"':;!?-]{7,}/", $password1) || !preg_match('/[a-z]/', $password1) || !preg_match('/[A-Z]/', $password1) || !preg_match('/[@#&+()\/*"\':;!?]/', $password1) || !preg_match('/-/', $password1) || !preg_match('/\d/', $password1)) {
            $errors[] = "Пароль не удовлетворяет требованиям безопасности. Пароль должен содержать: маленькие и большие буквы латинского алфавита, цифры, дефис, нижнее подчеркивание, особые символы (любой из @#&+()\/*\"\\':;!?), другие символы не допускаются, а также должен быть не короче 7 символов";
        }
